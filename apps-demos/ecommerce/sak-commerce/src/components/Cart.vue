                    ...
                    <div class="mt-8">
                      <div class="flow-root">
                        <ul role="list" class="-my-6 divide-y divide-gray-200">
                          <li v-if="cart.length === 0" class="text-center py-6">
                          ...
                          <li v-for="product in cart" :key="product.id" class="flex py-6">
                            ...
                            <div class="ml-4 flex flex-1 flex-col">
                              ...
                              <div class="flex flex-1 items-end justify-between text-sm">
                                ...
                                <div class="flex">
                                  <button type="button" @click="removeFromCart(product.id)" class="font-medium text-indigo-600 hover:text-indigo-500">Remove</button>
                                </div>
                              </div>
                            </div>
                          </li>
...
const { isCartOpen, closeCart, cart, removeFromCart, subtotal } = useCart()
</script>