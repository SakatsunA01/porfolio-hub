            ...
            <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <BaseCard
                        ...
                        :class="card.estilo"
                    >
                        <div class="absolute left-0 top-0 h-full w-1" :class="card.barra"></div>
                        <div class="pl-3">
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <button
                                    ...
                                    type="button"
                                    class="inline-flex min-h-[34px] items-center gap-2 rounded-full border border-surface-border bg-white px-3 py-1 text-xs font-semibold text-brand-navy shadow-sm transition hover:bg-brand-purple-soft/30 disabled:cursor-not-allowed disabled:opacity-60"
                            ...
                            <p class="mt-3 text-2xl font-extrabold leading-tight text-text-main sm:text-3xl">
                                {{ card.valor }}
                            </p>
